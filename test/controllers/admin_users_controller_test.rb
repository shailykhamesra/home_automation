...
class AdminUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_user" do
    assert_difference('AdminUser.count') do
      post admin_users_url, params: { admin_user: { email: 'abc@gmail.com', first_name: 'first_name', last_name: 'last_name', password: 'secret', password_confirmation: 'secret', username: 'username' }}
    end
